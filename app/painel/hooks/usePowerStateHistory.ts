...
export function usePowerStateHistory(
  ...
  // o cache local "congelado" de uma sessão anterior (mesmo bug do
  // useBatteryHistory.ts: gráfico preso num horário antigo porque o local
  // não estava vazio e o R2 nunca era consultado de novo).
  useEffect(() => {
