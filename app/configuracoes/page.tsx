...
export default function ConfiguracoesPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {/* Meu receptor — movido pra página própria */}
      <Link
        href="/meu-receptor"
        className="panel p-5 mb-6 flex items-center justify-between gap-3 hover:border-border-strong transition-all"
      >
        <div className="flex items-center gap-3">
          <Antenna size={18} className="text-blue-400 flex-shrink-0" />
          <div>
